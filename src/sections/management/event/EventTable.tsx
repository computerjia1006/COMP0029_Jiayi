...
export default function EventTable({ data, columns, modalToggler }: Props) {
      ...
      >
        ...
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} alignItems="center" sx={{ width: { xs: '100%', sm: 'auto' } }}>
          ...
          <Stack direction="row" spacing={2} alignItems="center"> 
            <Button variant="contained" startIcon={<PlusOutlined />} onClick={()=>router.push('/management/content/events/add')}>
              Add News 
            </Button>
