...
export default function CustomizedAutocomplete() {
  const [value, setValue] = useState([data[1], data[3], data[8]]);
  const { getRootProps, getInputProps, getTagProps, getListboxProps, getOptionProps, groupedOptions, focused, setAnchorEl } =
    useAutocomplete({
