...
import { DropzoneType, ThemeMode } from 'config';
...
export default function EditStory({ story, open, handleDrawerOpen }: Props) {
  ...
  const hoverEffect = {
    '& .MuiOutlinedInput-root': {
      '&:hover fieldset': {
        borderColor: theme.palette.mode === ThemeMode.DARK ? 'primary.main' : 'default.main'
      }
    }
  };
                    ...
                    <Grid container spacing={2.5}>
                      ...
                      <Grid item xs={12}>
                        <Stack spacing={1}>
                          ...
                          <FormControl fullWidth sx={{ m: 1, ...hoverEffect }}>
                            <Select
                              id="columnId"
                              name="columnId"
                              displayEmpty
