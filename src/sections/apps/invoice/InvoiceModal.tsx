...
export default function InvoiceModal({ isOpen, setIsOpen, invoiceInfo, items, onAddNextInvoice, values, invoiceMaster }: any) {
  function closeModal() {
    setIsOpen(false);
  }
            ...
            <Stack sx={{ flexDirection: { xs: 'column', sm: 'row' } }} justifyContent="space-between">
              <Box sx={{ pt: 2.5 }}>
                <Stack direction="row" spacing={2}>
                  <Logo /> <Chip label={values && values.status} variant="light" color="success" />
                </Stack>
