                            ...
                            <Grid item xs={12}>
                              <Stack spacing={2}>
                                <Stack direction="row" justifyContent="space-between">
                                  ...
                                  <Typography>
                                    {invoiceMaster.country?.prefix
                                      ? `${invoiceMaster.country.prefix} ${subtotal.toFixed(2)}`
                                      : subtotal.toFixed(2)}
                                  </Typography>
                                </Stack>
                                <Stack direction="row" justifyContent="space-between">
                                ...
                                <Stack direction="row" justifyContent="space-between">
                                  ...
                                  <Typography>
                                    {invoiceMaster.country?.prefix
                                      ? `${invoiceMaster.country.prefix} ${taxRate.toFixed(2)}`
                                      : taxRate.toFixed(2)}
                                  </Typography>
                                </Stack>
                                <Stack direction="row" justifyContent="space-between">
                                  ...
                                  <Typography variant="subtitle1">
                                    {invoiceMaster.country?.prefix
                                      ? `${invoiceMaster.country.prefix}${total % 1 === 0 ? total : total.toFixed(2)}`
                                      : total % 1 === 0
                                        ? total
                                        : total.toFixed(2)}
                                  </Typography>
                  ...
                  <FormControl sx={{ width: { xs: '100%', sm: 250 } }}>
                    <Autocomplete
                      ...
                      renderOption={({ key, ...props }, option) => (
                        <Stack key={key} component="li" direction="row" alignItems="center" gap={1} {...props}>
                          {option.code && (
                            <Image
                              loading="lazy"
                              className="flagImg"
