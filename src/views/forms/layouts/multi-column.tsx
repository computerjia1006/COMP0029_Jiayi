              ...
              <Grid container spacing={2} alignItems="center">
                ...
                <Grid item xs={12} sm={9} lg={8}>
                  <RadioGroup aria-label="gender" name="controlled-radio-buttons-group">
                    <FormControlLabel value="female" control={<Radio />} sx={{ width: 'fit-content' }} label="Administrator" />
                    <FormControlLabel value="male" control={<Radio />} sx={{ width: 'fit-content' }} label="Author" />
                  </RadioGroup>
                  <FormHelperText>Please select User Type</FormHelperText>
                </Grid>
              </Grid>
